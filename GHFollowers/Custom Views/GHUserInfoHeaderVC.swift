...
class GHUserInfoHeaderVC: UIViewController {
    ...
    let realnameLabel = GHSecondaryTitleLabel(fontSize: 18)
    ...
    func layoutUI()
    {
        ...
        let constraints = [
            ...
            realnameLabel.leadingAnchor.constraint(equalTo: avatarImageView.trailingAnchor, constant: textImagePadding),
